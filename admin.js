/* ============================================================
   ...
   ------------------------------------------------------------
   Panel de administración. Todo corre en el navegador y guarda
   en localStorage (no hay servidor real: GitHub Pages es
   hosting estático). La contraseña es una barrera básica para
   uso demo/personal, NO seguridad real — no la uses con datos
   sensibles. Ver README para cómo cambiarla.
   ============================================================ */
