/* ============================================================
   ...
   - DEFAULT_DATA es el "seed" (datos de fábrica).
   - En el primer visitante, app.js copia DEFAULT_DATA dentro de
     localStorage bajo la clave "f1_db".
   - A partir de ahí, TODO se lee y se escribe desde localStorage
     (incluyendo lo que hace el admin), así los cambios persisten
     entre visitas en el mismo navegador.
   - Como GitHub Pages es hosting estático (sin servidor/backend),
     localStorage es la única forma de simular una base de datos.
     Si necesitás que los cambios se vean en TODOS los navegadores,
     vas a necesitar un backend real (Firebase, Supabase, etc).
   ============================================================ */
...
const DEFAULT_DRIVERS = [
  {
    ...
    career: { wins: 15, podiums: 21, poles: 3, fastLaps: 5, dnf: 0, points: 512 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 3.80, oddsPrev: 3.90, probability: 28, oddsHistory: [4.30, 4.10, 3.90, 3.80],
    powerRank: 1, powerRankPrev: 2,
  },
  {
    ...
    career: { wins: 1, podiums: 14, poles: 9, fastLaps: 4, dnf: 2, points: 378 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 2.40, oddsPrev: 2.60, probability: 34, oddsHistory: [3.10, 2.95, 2.75, 2.60],
    powerRank: 2, powerRankPrev: 1,
  },
  {
    id: "carreon", name: "Manuel Carreon", number: 21, country: "México", flag: "🇲🇽",
    teamId: "redbull", status: "confirmado", rumorTeams: [],
    age: 42, seasons: 1, bestResult: "1°",
    ...
    career: { wins: 2, podiums: 6, poles: 5, fastLaps: 2, dnf: 4, points: 210 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 4.40, oddsPrev: 4.50, probability: 19, oddsHistory: [5.50, 5.10, 4.70, 4.40],
  ...
  },
  {
    ...
    career: { wins: 0, podiums: 13, poles: 2, fastLaps: 3, dnf: 2, points: 265 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 6.20, oddsPrev: 6.60, probability: 14, oddsHistory: [6.90, 6.70, 6.40, 6.20],
    powerRank: 4, powerRankPrev: 4,
  },
  {
    id: "acosta", name: "Hernán Acosta", number: 40, country: "Argentina", flag: "🇦🇷",
    teamId: "redbull", status: "confirmado", rumorTeams: [],
    age: 14, seasons: 5, bestResult: "4°",
    ...
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
    odds: 9.50, oddsPrev: 10.00, probability: 9, oddsHistory: [11.00, 10.40, 10.20, 9.50],
    powerRank: 5, powerRankPrev: 7,
  },
  {
    id: "mauricio", name: "Mauricio", number: 75, country: "México", flag: "🇲🇽",
    teamId: "ferrari", status: "confirmado", rumorTeams: [],
    age: 15, seasons: 1, bestResult: "5°",
  ...
  },
  {
    ...
    age: 25, seasons: 1, bestResult: "8°",
    bio: "Piloto libre a la espera de equipo para la 26/27.",
    career: { wins: 0, podiums: 6, poles: 0, fastLaps: 0, dnf: 5, points: 55 },
    season: { wins: 0, podiums: 0, poles: 0, fastLaps: 0, dnf: 0, points: 0 },
  ...
  },
  {
    ...
    age: 14, seasons: 1, bestResult: "11°",
  ...
  },
  {
    ...
    age: 15, seasons: 1, bestResult: "12°",
  ...
  },
  {
    ...
    age: 14, seasons: 1, bestResult: "13°",
  ...
  },
  {
    ...
    teamId: null, status: "libre", rumorTeams: [],
    age: 13, seasons: 1, bestResult: "10°",
    bio: "Piloto libre a la espera de equipo para la 26/27.",
...
const DEFAULT_CALENDAR = [
  { round: 1,  circuit: "Bahréin",        flag: "🇧🇭", r1: "2026-09-12", r2: "2026-09-13", finished: false, results: {} },
  { round: 2,  circuit: "Qatar",          flag: "🇶🇦", r1: "2026-09-19", r2: "2026-09-20", finished: false, results: {} },
  { round: 3,  circuit: "China",          flag: "🇨🇳", r1: "2026-09-26", r2: "2026-09-27", finished: false, results: {} },
  { round: 4,  circuit: "Malasia",        flag: "🇲🇾", r1: "2026-10-03", r2: "2026-10-04", finished: false, results: {} },
  { round: 5,  circuit: "Australia",      flag: "🇦🇺", r1: "2026-10-10", r2: "2026-10-11", finished: false, results: {} },
  { round: 6,  circuit: "Mount Panorama", flag: "🇦🇺", r1: "2026-10-17", r2: "2026-10-18", finished: false, results: {} },
  { round: 7,  circuit: "Canadá",         flag: "🇨🇦", r1: "2026-10-24", r2: "2026-10-25", finished: false, results: {} },
  { round: 8,  circuit: "Miami",          flag: "🇺🇸", r1: "2026-10-31", r2: "2026-11-01", finished: false, results: {} },
  { round: 9,  circuit: "South Carolina", flag: "🇺🇸", r1: "2026-11-07", r2: "2026-11-08", finished: false, results: {} },
  { round: 10, circuit: "Barcelona",      flag: "🇪🇸", r1: "2026-11-14", r2: "2026-11-15", finished: false, results: {} },
  { round: 11, circuit: "Mónaco",         flag: "🇲🇨", r1: "2026-11-21", r2: "2026-11-22", finished: false, results: {} },
  { round: 12, circuit: "Austria",        flag: "🇦🇹", r1: "2026-11-28", r2: "2026-11-29", finished: false, results: {} },
  { round: 13, circuit: "Hungría",        flag: "🇭🇺", r1: "2026-12-05", r2: "2026-12-06", finished: false, results: {} },
  { round: 14, circuit: "Bélgica",        flag: "🇧🇪", r1: "2026-12-12", r2: "2026-12-13", finished: false, results: {} },
  { round: 15, circuit: "Reino Unido",    flag: "🇬🇧", r1: "2026-12-19", r2: "2026-12-20", finished: false, results: {} },
  { round: 16, circuit: "Georgia",        flag: "🇬🇪", r1: "2026-12-26", r2: "2026-12-27", finished: false, results: {} },
  { round: 17, circuit: "Italia",         flag: "🇮🇹", r1: "2027-01-02", r2: "2027-01-03", finished: false, results: {} },
  { round: 18, circuit: "Singapur",       flag: "🇸🇬", r1: "2027-01-09", r2: "2027-01-10", finished: false, results: {} },
  { round: 19, circuit: "EE.UU.",         flag: "🇺🇸", r1: "2027-01-16", r2: "2027-01-17", finished: false, results: {} },
  { round: 20, circuit: "México",         flag: "🇲🇽", r1: "2027-01-23", r2: "2027-01-24", finished: false, results: {} },
  { round: 21, circuit: "Las Vegas",      flag: "🇺🇸", r1: "2027-01-30", r2: "2027-01-31", finished: false, results: {} },
  { round: 22, circuit: "Brasil",         flag: "🇧🇷", r1: "2027-02-06", r2: "2027-02-07", finished: false, results: {} },
  { round: 23, circuit: "Arabia Saudita", flag: "🇸🇦", r1: "2027-02-13", r2: "2027-02-14", finished: false, results: {} },
  { round: 24, circuit: "Abu Dabi",       flag: "🇦🇪", r1: "2027-02-20", r2: "2027-02-21", finished: false, results: {} },
